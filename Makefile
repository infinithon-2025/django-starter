...
docs:
	...
	@echo ""
	@echo "🌟 하이라이트된 API 문서:"
	@echo "하이라이트 Swagger UI: http://localhost:8000/api/docs/highlighted/"
	@echo "하이라이트 ReDoc: http://localhost:8000/api/redoc/highlighted/"
	@echo "하이라이트 Schema: http://localhost:8000/api/schema/highlighted/"
	@echo "하이라이트 설정: http://localhost:8000/api/highlight/"
